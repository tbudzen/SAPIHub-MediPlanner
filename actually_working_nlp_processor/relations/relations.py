...
class RelationsUtils():
    ...
    def tagsFromAnn(self, annContent: str):
        lines = filter(lambda line: line.startswith('T') and self.isAbleToCreateTag(line), annContent.splitlines())
