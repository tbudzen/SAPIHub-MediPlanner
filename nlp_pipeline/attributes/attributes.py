...
from nlp_pipeline.attributes.ann_model import AnnProcessor
...
class Attributes():
	...
	def strip_annotations(self, ann_dir, char):
	...
	def annotate(self, dir, status_rfc_filename, status_bc_filename, status_bc_date_filename, source_bc_filename, dataset_source_filename, dataset_status_filename_1, dataset_status_filename_2):

		print("annotate cwd = " + os.getcwd())
...
if __name__ == "__main__":
	...
	if cnt == 2:
		...
		dir  = sys.argv[2]
		if mode == "-s":
			Attributes.strip_annotations(dir, "A")
		elif mode == "-t":
